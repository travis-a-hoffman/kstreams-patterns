...
public class HelloError extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.firkin.kstreams.normalizer.errors.HelloError.Builder newBuilder() {
    return new io.firkin.kstreams.normalizer.errors.HelloError.Builder();
  }
   ...
   * @return A new HelloError RecordBuilder
   */
  public static io.firkin.kstreams.normalizer.errors.HelloError.Builder newBuilder(io.firkin.kstreams.normalizer.errors.HelloError.Builder other) {
    if (other == null) {
      return new io.firkin.kstreams.normalizer.errors.HelloError.Builder();
    } else {
      return new io.firkin.kstreams.normalizer.errors.HelloError.Builder(other);
    }
  }
   ...
   * @return A new HelloError RecordBuilder
   */
  public static io.firkin.kstreams.normalizer.errors.HelloError.Builder newBuilder(io.firkin.kstreams.normalizer.errors.HelloError other) {
    if (other == null) {
      return new io.firkin.kstreams.normalizer.errors.HelloError.Builder();
    } else {
      return new io.firkin.kstreams.normalizer.errors.HelloError.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HelloError>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.firkin.kstreams.normalizer.errors.HelloError.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.firkin.kstreams.normalizer.errors.HelloError other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder setEventId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder setPersonName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.HelloError.Builder clearPersonName() {
      personName = null;
