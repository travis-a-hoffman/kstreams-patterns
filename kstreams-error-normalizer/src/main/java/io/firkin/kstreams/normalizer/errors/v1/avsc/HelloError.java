...
public class HelloError extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8795915786330338850L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HelloError\",\"namespace\":\"io.firkin.kstreams.normalizer.errors.v1.avsc\",\"doc\":\"Model for a HelloWorld errors topic. This acts as a source Error Topic Schema for Normalizer test Cases.\",\"fields\":[{\"name\":\"eventId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\",\"default\":\"\"},\"doc\":\"The business UUID \"},{\"name\":\"correlationId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\",\"default\":\"\"},\"doc\":\"The system-wide correlation UUID, which can be used for event tracing across systems.\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"personName\",\"type\":{\"type\":\"string\",\"default\":\"World\"},\"doc\":\"The name of the person to say hello to.\"}]}");
  ...
  /** The name of the person to say hello to. */
   private java.lang.CharSequence personName;
   ...
   */
  public HelloError(java.lang.CharSequence eventId, java.lang.CharSequence correlationId, java.lang.Long timestamp, java.lang.CharSequence personName) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: personName = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.lang.CharSequence getPersonName() {
    return personName;
  }
   ...
   * @param value the value to set.
   */
  public void setPersonName(java.lang.CharSequence value) {
   ...
   */
  public static io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder newBuilder() {
    return new io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder();
  }
   ...
   * @return A new HelloError RecordBuilder
   */
  public static io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder newBuilder(io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder other) {
    if (other == null) {
      return new io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder();
    } else {
      return new io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder(other);
    }
  }
   ...
   * @return A new HelloError RecordBuilder
   */
  public static io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder newBuilder(io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError other) {
    if (other == null) {
      return new io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder();
    } else {
      return new io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HelloError>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder setEventId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder setPersonName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.firkin.kstreams.normalizer.errors.v1.avsc.HelloError.Builder clearPersonName() {
      personName = null;
    ...
    public HelloError build() {
      try {
        ...
        record.personName = fieldSetFlags()[3] ? this.personName : (java.lang.CharSequence) defaultValue(fields()[3]);
        return record;
